...
export default function AdminHeader() {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10 sm:mb-12">
      <Link href="/" className="group flex items-center gap-2 text-foreground/65 hover:text-foreground transition-all duration-300">
        <div className="p-2 rounded-lg bg-(--card-bg-secondary) border border-(--border-color) group-hover:border-brand/40 group-hover:bg-brand/10">
